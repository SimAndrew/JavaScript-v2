...
function t2() {
  fetch(
    "http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=2&name=Andrew",
    {
      method: "GET",
    }
  )
...
function t3() {
  fetch(
    "http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=3&num1=10&num2=15",
    {
      method: "GET",
    }
  )
...
function t4() {
  fetch(
    "http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=4&num1=25&num2=50",
    {
      method: "GET",
    }
  )
...
function t6() {
  fetch(
    "http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=6&num1=25&num2=50",
    {
      method: "GET",
    }
  )
...
function t8() {
  fetch(
    "http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=8&year=1990",
    {
      method: "GET",
    }
  )
...
function t12() {
  fetch("http://getpost.itgid.info/index2.php", {
    ...
    body: "auth=7859d9d42a8834141d529577207c9596&action=3&num1=10&num2=20",
  })
    .then((data) => data.text())
...
function t13() {
  fetch("http://getpost.itgid.info/index2.php", {
    ...
    body: "auth=7859d9d42a8834141d529577207c9596&action=4&num1=10&num2=40",
  })
    .then((data) => data.text())
...
function t15() {
  fetch("http://getpost.itgid.info/index2.php", {
    ...
    body: "auth=7859d9d42a8834141d529577207c9596&action=6&num1=60&num2=40",
  })
    .then((data) => data.text())
...
function t18() {
  fetch("http://getpost.itgid.info/index2.php", {
    ...
    body: "auth=7859d9d42a8834141d529577207c9596&action=9&d=1",
  })
    .then((data) => data.text())
