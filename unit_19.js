...
function t3() {
    ...
    out3.innerHTML = div3.style.width;
}
...
div13.onmousedown = () => (div13.classList.add('active'));
div13.onmouseup = () => (div13.classList.remove('active'));
...
function t19() {
    div19.classList.forEach(element => {
        div19.innerHTML += element + '<br>';
    });
}
