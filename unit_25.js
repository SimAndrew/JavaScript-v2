...
function t1() {
  ...
  req.open('GET', 'http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=1', true);
  req.send();

  req.onreadystatechange = function () {
    if (this.readyState === 4 && this.status === 200) {
      t1_1(this.responseText);
    }
  };
}
...
function t2() {
  let req = new XMLHttpRequest();
  req.open('GET', 'http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=2&name=Andrew', true);
  req.send();

  req.onreadystatechange = function () {
    if (this.readyState === 4 && this.status === 200) {
      t2_1(this.responseText);
    }
  };
}
...
function t3() {
  let req = new XMLHttpRequest();
  req.open('GET', 'http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=3&num1=5&num2=10', true);
  req.send();

  req.onreadystatechange = function () {
    if (this.readyState === 4 && this.status === 200) {
      t3_1(this.responseText);
    }
  };
}
...
function t4() {
  let req = new XMLHttpRequest();
  req.open('GET', 'http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=4&num1=10&num2=30', true);
  req.send();

  req.onreadystatechange = function () {
    if (this.readyState === 4 && this.status === 200) {
      t4_1(this.responseText);
    }
  };
}
...
function t5() {
  let req = new XMLHttpRequest();
  req.open('GET', 'http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=5', true);
  req.send();

  req.onreadystatechange = function () {
    if (this.readyState === 4 && this.status === 200) {
      t5_1(this.responseText);
    }
  };
}
...
function t6() {
  let req = new XMLHttpRequest();
  req.open('GET', 'http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=6&num1=10&num2=30', true);
  req.send();

  req.onreadystatechange = function () {
    if (this.readyState === 4 && this.status === 200) {
      t6_1(this.responseText);
    }
  };
}
...
function t7() {
  let req = new XMLHttpRequest();
  req.open('GET', 'http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=7', true);
  req.send();

  req.onreadystatechange = function () {
    if (this.readyState === 4 && this.status === 200) {
      t7_1(this.responseText);
    }
  };
}
...
function t8() {
  let req = new XMLHttpRequest();
  req.open('GET', 'http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=8&year=1990', true);
  req.send();

  req.onreadystatechange = function () {
    if (this.readyState === 4 && this.status === 200) {
      t8_1(this.responseText);
    }
  };
}
...
function t9() {
  let req = new XMLHttpRequest();
  req.open('GET', 'http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=9&m=1', true);
  req.send();

  req.onreadystatechange = function () {
    if (this.readyState === 4 && this.status === 200) {
      t9_1(this.responseText);
    }
  };
}
...
function t10() {
  let req = new XMLHttpRequest();
  req.open('POST', 'http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=1', true);
  req.setRequestHeader('content-type', 'application/x-www-form-urlencoded');
  req.send();

  req.onreadystatechange = function () {
    if (this.readyState === 4 && this.status === 200) {
      t10_1(this.responseText);
    }
  };
}
...
function t11() {
  let req = new XMLHttpRequest();
  req.open('POST', 'http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=2&name=Andrew', true);
  req.setRequestHeader('content-type', 'application/x-www-form-urlencoded');
  req.send();

  req.onreadystatechange = function () {
    if (this.readyState === 4 && this.status === 200) {
      t11_1(this.responseText);
    }
  };
}
...
function t12() {
  let req = new XMLHttpRequest();
  req.open('POST', 'http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=3&num1=15&num2=35', true);
  req.setRequestHeader('content-type', 'application/x-www-form-urlencoded');
  req.send();

  req.onreadystatechange = function () {
    if (this.readyState === 4 && this.status === 200) {
      t12_1(this.responseText);
    }
  };
}
...
function t13() {
  let req = new XMLHttpRequest();
  req.open('POST', 'http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=4&num1=25&num2=50', true);
  req.setRequestHeader('content-type', 'application/x-www-form-urlencoded');
  req.send();

  req.onreadystatechange = function () {
    if (this.readyState === 4 && this.status === 200) {
      t13_1(this.responseText);
    }
  };
}
...
function t14() {
  let req = new XMLHttpRequest();
  req.open('POST', 'http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=5', true);
  req.setRequestHeader('content-type', 'application/x-www-form-urlencoded');
  req.send();

  req.onreadystatechange = function () {
    if (this.readyState === 4 && this.status === 200) {
      t14_1(this.responseText);
    }
  };
}
...
function t15() {
  let req = new XMLHttpRequest();
  req.open('POST', 'http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=6&num1=25&num2=15', true);
  req.setRequestHeader('content-type', 'application/x-www-form-urlencoded');
  req.send();

  req.onreadystatechange = function () {
    if (this.readyState === 4 && this.status === 200) {
      t15_1(this.responseText);
    }
  };
}
...
function t16() {
  let req = new XMLHttpRequest();
  req.open('POST', 'http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=7', true);
  req.setRequestHeader('content-type', 'application/x-www-form-urlencoded');
  req.send();

  req.onreadystatechange = function () {
    if (this.readyState === 4 && this.status === 200) {
      t16_1(this.responseText);
    }
  };
}
...
function t17() {
  let req = new XMLHttpRequest();
  req.open('POST', 'http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=8&year=1990', true);
  req.setRequestHeader('content-type', 'application/x-www-form-urlencoded');
  req.send();

  req.onreadystatechange = function () {
    if (this.readyState === 4 && this.status === 200) {
      t17_1(this.responseText);
    }
  };
}
...
function t18() {
  let req = new XMLHttpRequest();
  req.open('POST', 'http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=9&y=1', true);
  req.setRequestHeader('content-type', 'application/x-www-form-urlencoded');
  req.send();

  req.onreadystatechange = function () {
    if (this.readyState === 4 && this.status === 200) {
      t18_1(this.responseText);
    }
  };
}
